...
const handleNextStep = (params = {}) => {
  ...
  // Pass custom round count via query params if set
  if (params.maxRounds) {
  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      try {
        ...
        addLog(`Close environment error: ${closeErr.message}`)
    ...
    // Failure to check environment status doesn't block subsequent flow
