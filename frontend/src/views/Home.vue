            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity-relationship extraction & persona generation & Agent parameter injection</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parsing prediction requirements & dynamic memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction needs in natural language (e.g., What public opinion trends would emerge if a university reverses a disciplinary action?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Start simulation - jump immediately, API call happens on Process page
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Jump to Process page immediately (using special identifier for new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Space Grotesk as main heading font, JetBrains Mono as code/label font
