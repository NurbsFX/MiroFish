              ...
              <div class="timeline-content">
                ...
                <div class="timeline-body" :class="{ 'collapsed': isLogCollapsed(log) }" @click="toggleLogExpand(log)">
                  ...
                  <template v-if="log.action === 'llm_response'">
                    ...
                    <!-- When it is the final answer, show special prompt -->
    ...
    interviewBlocks.forEach((block, index) => {
      ...
      if (qMatch) {
        ...
        if (questions.length > 0) {
          // If the first question is preceded by "1.", needs special handling
...
const renderMarkdown = (content) => {
  ...
  // Remove leading h2 title (## xxx), since the section title is already displayed in the outer element
