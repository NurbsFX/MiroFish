  ...
  >
    ...
    <div v-if="projects.length > 0" class="cards-container" :class="{ expanded: isExpanded }" :style="containerStyle">
      ...
      >
        ...
        <!-- Card title (first 20 chars of Simulation Requirements as title) -->
...
// Generate title from Simulation Requirements (first 20 chars)
...
// Format simulation_id for display (first 6 chars)
  ...
  observer = new IntersectionObserver(
    (entries) => {
      entries.forEach((entry) => {
        ...
        // Use debounced delay for state transition to prevent rapid flickering
        ...
        expandDebounceTimer = setTimeout(() => {
          ...
          // Check if pending state still needs executing (may have been overridden)
...
.grid-pattern {
  ...
  /* Positioned from top-left; height changes only extend the bottom without affecting existing grid positions */
