...
Uses preset scripts + LLM-generated intelligent configuration parameters
"""
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Args:
            ...
            use_llm_for_profiles: Whether to use LLM for generating detailed personas
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No qualifying entities found. Please verify that the graph was built correctly."
                self._save_simulation_state(state)
                return state
