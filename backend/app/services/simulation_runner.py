...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        try:
            ...
            # Create main log file to prevent process blocking due to stdout/stderr pipe buffer overflow
    ...
    def _monitor_simulation(cls, simulation_id: str):
        ...
        # Log structure: per-platform action logs
    ...
    def get_all_actions(
        ...
        # If per-platform files don't exist, try reading the legacy single-file format
        if not actions:
    ...
    def register_cleanup(cls):
        ...
        Called at Flask application startup to ensure all simulation processes are cleaned up when the server shuts down
        """
    ...
    def check_env_alive(cls, simulation_id: str) -> bool:
        ...
        Returns:
            True if environment is alive, False if environment has shut down
        """
        sim_dir = os.path.join(cls.RUN_STATE_DIR, simulation_id)
        if not os.path.exists(sim_dir):
            return False
    ...
    def close_simulation_env(
        ...
        """
        Close the simulation environment (not the simulation process)
    ...
    def get_interview_history(
        ...
        Args:
            ...
            agent_id: Specific Agent ID (optional, get only this Agent's history)
