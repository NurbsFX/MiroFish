...
1. InsightForge (deep insight retrieval) - The most powerful hybrid retrieval, auto-generates sub-queries and searches across multiple dimensions
...
class InsightForgeResult:
    ...
    Contains retrieval results from multiple sub-queries and a consolidated analysis
    """
    query: str
    simulation_requirement: str
    sub_queries: List[str]

    # Results from each dimension
    ...
    def to_text(self) -> str:
        ...
        if self.key_quotes:
            ...
            for quote in self.key_quotes:
                ...
                skip = False
                for d in '123456789':
                    if f'Question {d}' in clean_quote or f'Q{d}' in clean_quote:
                        skip = True
                        break
                if skip:
                    continue
...
class ZepToolsService:
    ...
    4. interview_agents - In-depth interview (interview simulated agents, get multi-perspective opinions)
    ...
    def get_all_nodes(self, graph_id: str) -> List[NodeInfo]:
        """
        Get all nodes of the graph (with pagination)
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges of the graph (with pagination, including temporal information)
    ...
    def insight_forge(
        ...
        The most powerful hybrid retrieval function, automatically decomposes problems and retrieves across multiple dimensions:
...
Return the sub-question list in JSON format."""
    ...
    def panorama_search(
        ...
        This tool is suitable for scenarios requiring a full picture of events and tracking their evolution.
    ...
    def interview_agents(
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "all past memories, and actions, using plain text.\n"
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Strategy 2 (supplementary): Properly paired quoted long text
                if not key_quotes:
    ...
    def _select_agents_for_interview(
        ...
        Returns:
            tuple: (selected_agents, selected_indices, reasoning)
                - selected_agents: Complete information for selected agents
