...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        Uses a natural language description format so Zep can extract entities and relationships from it.
    ...
    def _describe_like_post(self) -> str:
        """Like post - includes post content and author information"""
    ...
    def _describe_dislike_post(self) -> str:
        """Dislike post - includes post content and author information"""
        post_content = self.action_args.get("post_content", "")
        post_author = self.action_args.get("post_author_name", "")
    ...
    def _describe_create_comment(self) -> str:
        """Post comment - includes comment content and the commented post information"""
        content = self.action_args.get("content", "")
        post_content = self.action_args.get("post_content", "")
        post_author = self.action_args.get("post_author_name", "")
...
class ZepGraphMemoryUpdater:
    ...
    All meaningful actions are updated to Zep. action_args includes complete context information:
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args includes complete context information (such as post content, usernames, etc.).
