...
# Adding this prefix prevents the Agent from calling tools, making it reply directly with text
...
def create_simulation():
    ...
    try:
        ...
        if not graph_id:
            return jsonify({
                "success": False,
                "error": "Graph has not been built for this project yet. Please call /api/graph/build first"
            }), 400
...
def _check_simulation_prepared(simulation_id: str) -> tuple:
    """
    Check whether the simulation is fully prepared
    ...
    try:
        ...
        # - running: Currently running, so preparation was done long ago
        # - completed: Run completed, so preparation was done long ago
        # - stopped: Stopped, so preparation was done long ago
...
def get_simulation_history():
    ...
    try:
        ...
        for sim in simulations:
            ...
            # Get associated report_id (find the simulation's latest report)
...
def get_simulation_config_realtime(simulation_id: str):
    ...
    - Suitable for real-time viewing during generation
    - Returns additional metadata (e.g., file modification time, whether generation is in progress)
    - Can return partial info even if config generation isn't complete
...
def start_simulation():
    ...
    About the force parameter:
        ...
        - Useful for scenarios requiring a simulation re-run
