...
def build_graph():
    ...
    try:
        ...
        if project.status == ProjectStatus.GRAPH_BUILDING and not force:
            return jsonify({
                "success": False,
                "error": "Graph is currently being built. Do not submit again. To force a rebuild, add force: true",
        ...
        def build_task():
            ...
            try:
                ...
                # Wait for Zep to finish processing (check each episode's processed status)
                task_manager.update_task(
                    task_id,
